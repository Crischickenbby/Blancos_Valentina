...
document.addEventListener('DOMContentLoaded', function () {
    ...
    searchInput.addEventListener('input', function () {
        ...
        // Selecciona todas las tarjetas de empleados
        const employeeCards = document.querySelectorAll('.grid > div.bg-white');
        employeeCards.forEach(card => {
            // Busca el nombre y apellido dentro de la tarjeta
