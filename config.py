...
DB_HOST = os.getenv('DB_HOST', 'localhost') #os es para Windows getenv es para Linux pero estoy utilizando Windows y funciona
DB_NAME = os.getenv('DB_NAME', 'Blancos_Valentina_Ataque')
